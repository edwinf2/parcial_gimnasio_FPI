  						    ...
  						    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
  						        ...
  						        if (mysqli_affected_rows($con) == 1) {
  						            while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
  						                ...
  						                echo "<td><form action='nuevatablamiembros.php' method='post'><input type='hidden' name='nombre' value='" . $cambiar . "'/><input type='hidden' name='nombrecompleto' value='" . $cambiar1 . "'/><input type='submit' value='Nuevo Programa' class='btn btn-info'/></form><form action='vertablamiembros.php' method='post'><input type='hidden' name='nombre' value='" . $cambiar . "'/><input type='hidden' name='nombrecompleto' value='" . $cambiar1 . "'/><input type='submit' value='Ver Programa' class='btn btn-warning'/></form></td></tr>";
  						                $cambiar = 0;
  						            }
  						        }
  						    }
