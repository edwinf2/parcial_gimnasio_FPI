  ...
  <body class="page-body  page-fade">
    <div class="page-container">
      ...
      <div class="main-content">
        ...
        <h2>Vista General</h2>
        <hr/>
        <form action="duracionmes.php" method="POST" class='form-horizontal form-bordered'>
  				<div class="form-group">
  					<label for="field-1" class="col-sm-3 control-label">De:</label>
  						<div class="col-sm-5">
  							<input type="text" name="de" id="textfield22"  class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
  						</div>
  				</div>
  				<div class="form-group">
  					<label for="field-1" class="col-sm-3 control-label">A :</label>
  						<div class="col-sm-5">
  							 <input type="text" name="para" id="textfield22" class="form-control datepicker" value="<?php echo date('Y-m-d'); ?>">
  						</div>
  				</div>
